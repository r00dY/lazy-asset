...
class LazyAsset {
	...
	public static function put($options) {
		...
		<div class="lazy-asset <?= $mode ?> <?php if ($options["autosizes"]): ?>lazy-asset-auto-sizes<?php endif; ?> <?= $options["classes"] ?>" data-anim="<?php echo $options["animation"]; ?>"  data-aspect-ratio="<?= $options["aspect_ratio"] ?>" <?= self::pasteAttributes($options); ?>>
